    ...
    <div className="Main">
      ...
      <div className="container-basic">
        ...
        <div className="container-main">
          ...
          <p>• My name is Shuli, a software developer with a passion for both coding and photography. You can find more about me in the About section in the header</p>
