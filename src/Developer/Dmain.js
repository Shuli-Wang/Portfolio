    ...
    return (
        <div className="Testimonials">
            <div className="container-basic">
                ...
                <div className="container-testimonials">
                    <p style={{ marginTop:'6%',fontWeight: 'bold' }}>Video Transmission System Based on the Neural Network</p>
                ...
                <div className="container-testimonials">
                    <p style={{ marginTop:'6%', fontWeight: 'bold' }}>Digital Tourism</p>
                ...
                <div className="container-testimonials">
                    <p style={{ marginTop:'6%', fontWeight: 'bold' }}>Smart Obstacle Detector</p>
