        ...
        <div className="Testimonials">
            ...
            <div className="container-basic" style={{ alignItems: 'flex-start' }}>
                ...
                <div className="container-testimonials-right">
                    <p style={{ marginTop: '6%', fontWeight: 'bold' }}>- Dylan, Classmate</p>
                ...
                <div className="container-testimonials">
                    <p style={{  marginTop: '6%',fontWeight: 'bold' }}>- Yuhan, Friend from middle school</p>
                ...
                <div className="container-testimonials-right">
                    <p style={{  marginTop: '6%',fontWeight: 'bold' }}>- Gehao, Professor</p>
