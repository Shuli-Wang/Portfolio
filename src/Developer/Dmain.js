    ...
    return (
        <div className="Testimonials">
            <div className="container-basic">
                ...
                <div className="container-testimonials">
                <Link to="https://www.e-hospital.ca/" target="_blank" rel="noopener noreferrer"><p style={{ fontWeight: 'bold' }}>EHR e-hospital</p></Link>
                ...
                <div className="container-testimonials">
                    <p style={{ marginTop: '40px', fontWeight: 'bold' }}>User Portrait Model for Digital Tourism</p>
