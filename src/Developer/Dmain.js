    ...
    return (
        <div className="Testimonials">
            <div className="container-basic">
                <h1 style={{ width: '96%',  background: 'linear-gradient(to bottom, transparent 50%, #d2dbd0 50%' }}>UpComing</h1>
                <div className="container-testimonials" style={{marginLeft:'0px'}}>
                ...
                <h1 style={{ width: '96%', background: 'linear-gradient(to bottom, transparent 50%, #d2dbd0 50%' }}>Completed</h1>
                ...
                <div className="container-testimonials">
                    <p style={{ fontWeight: 'bold' }}>Video Transmission System Based on the Neural Network</p>
                ...
                <div className="container-testimonials">
                    <p style={{ fontWeight: 'bold' }}>Digital Tourism</p>
                ...
                <div className="container-testimonials">
                    <p style={{ fontWeight: 'bold' }}>Smart Obstacle Detector</p>
